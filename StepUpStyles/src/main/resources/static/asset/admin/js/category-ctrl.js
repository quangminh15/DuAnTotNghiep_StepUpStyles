app.controller("category-ctrl", function($scope, $http) {
	...
	$scope.exportExcel = function () {
		$http({
		  method: "POST",
		  url: "/export-excelCategory", // Thay thế với URL phía máy chủ đúng
		  data: $scope.categoryitems,
		  ...
		  .then(function (response) {
			...
			var a = document.createElement("a");
			a.href = url;
			a.download = "CategoryStepUpStyle.xlsx"; // Đặt tên tệp Excel mong muốn
			document.body.appendChild(a);
			a.click();
			URL.revokeObjectURL(url);
		  })
