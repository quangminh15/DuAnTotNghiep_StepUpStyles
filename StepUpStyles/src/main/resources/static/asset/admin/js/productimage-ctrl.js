app.controller("productimage-ctrl", function($scope, $http) {
	...
	$scope.exportPdf = function () {
		$http({
		  method: "POST",
		  url: "/productimage-pdf",
		  data: $scope.productimageitems,
	...
	$scope.exportExcel = function () {
		$http({
		  method: "POST",
		  url: "/export-excelProductImage", // Thay thế với URL phía máy chủ đúng
		  data: $scope.productimageitems,
		  ...
		  .then(function (response) {
			...
			var a = document.createElement("a");
			a.href = url;
			a.download = "ProductImageStepUpStyle.xlsx"; // Đặt tên tệp Excel mong muốn
			document.body.appendChild(a);
			a.click();
			URL.revokeObjectURL(url);
		  })
