...
public class BrandRestController {
	...
	@GetMapping("/rest/brands/loadallNoDeletedAndActivitiesTrue")
	public List<Brand> getAllNoDeletedAndActivitiesTrue() {
		return brandService.loadAllNoDeletedAndActivitiesTrue();
	}
