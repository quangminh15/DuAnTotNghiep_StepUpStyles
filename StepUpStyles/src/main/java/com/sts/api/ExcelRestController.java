...
public class ExcelRestController {
    ...
    public void exportExcel(HttpServletResponse response, @RequestBody List<ImportReceiptDetail> importDetail)
        ...
        response.setHeader("Content-Disposition", "attachment; filename=import_receipt.xlsx");

        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("Import Receipt");
        ...
        int rowNum = 4; // Bắt đầu từ hàng số 2 sau dòng tiêu đề
